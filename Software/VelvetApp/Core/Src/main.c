...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, ESP_EN_Pin|SPI1_CS_Pin|RFID_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_12|GPIO_PIN_13|HX_DOUT_Pin|HX_SCK_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : ESP_EN_Pin SPI1_CS_Pin RFID_EN_Pin */
  GPIO_InitStruct.Pin = ESP_EN_Pin|SPI1_CS_Pin|RFID_EN_Pin;
